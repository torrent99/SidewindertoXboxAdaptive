...
// SKS #define USB_MANUFACTURER_ID		wUSB( 0x045E )	/* Microsoft */
#define USB_MANUFACTURER_ID		wUSB( 0x2341 )	/* arduino */

#define	USB_PRODUCT_ID_3DP		wUSB( 0x0002 )
// SKS #define	USB_PRODUCT_ID_PP		wUSB( 0x0004 )
#define	USB_PRODUCT_ID_PP		wUSB( 0x8036 ) /* arduino */
